const id = "FastAPI-products-catalog-microservice.md";
						const collection = "projects";
						const slug = "products-catalog-microservice";
						...
						const data = {title:"FastAPI products-catalog microservice",description:"A products-catalog microservice for an e-commerce system.",pubDate:new Date(1688688000000),image:"/assets/images/projects/product_catalog_api_service.png",url:"https://github.com/imirghania/FastAPI_e-commerce_product_catalog_service",tags:["web-dev","FastAPI","e-commerce"],isPublished:true};
						const _internal = {
							type: 'content',
							filePath: "/home/ubuntu_wsl/main-blog/src/content/projects/FastAPI-products-catalog-microservice.md",
							rawData: undefined,
						};
